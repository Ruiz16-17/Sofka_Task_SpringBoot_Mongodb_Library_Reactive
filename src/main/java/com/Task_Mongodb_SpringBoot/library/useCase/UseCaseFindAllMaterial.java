...
@Service
@Validated
public class UseCaseFindAllMaterial implements Supplier<Flux<MaterialDTO>> {

    private final MaterialRepository materialRepository;
    private  final MaterialMapper materialMapper;

    @Autowired
    public UseCaseFindAllMaterial(MaterialRepository materialRepository, MaterialMapper materialMapper) {
    ...
    public Flux<MaterialDTO> get() {
        return materialRepository.findAll().map(materialMapper.mapDatoToDTO());
    }
