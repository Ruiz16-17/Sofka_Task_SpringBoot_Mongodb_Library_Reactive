...
@Service
@Validated
public class FindByIdMaterialUseCase implements Function<String, Mono<MaterialDTO>> {
    private final MaterialRepository materialRepository;
    private  final MaterialMapper materialMapper;

    public FindByIdMaterialUseCase(MaterialRepository materialRepository, MaterialMapper materialMapper) {
